...
async def send_media_group(
    ...
    Parameters:
        chat_id (``int`` | ``str``):
            ...
            For your personal cloud (Saved Messages) you can simply use "me" or "bot".
    ...
    for i in media:
        if isinstance(i, types.InputMediaPhoto):
            if isinstance(i.media, str):
                    ...
                    media = await bot.invoke(
                        raw.functions.messages.UploadMedia(
                            ...
                            media=raw.types.InputMediaUploadedPhoto(
                                file=await bot.save_file(i.media)
                            ),
                        )
                    )
                ...
                media = await bot.invoke(
                    raw.functions.messages.UploadMedia(
                        peer=await bot.resolve_peer(chat_id),
                        media=raw.types.InputMediaUploadedPhoto(file=await bot.save_file(i.media)),
                    )
                )
                    ...
                    media = await bot.invoke(
                        raw.functions.messages.UploadMedia(
                            ...
                            media=raw.types.InputMediaUploadedDocument(
                                file=await bot.save_file(i.media),
                                thumb=await bot.save_file(i.thumb),
                                mime_type=bot.guess_mime_type(i.media) or "video/mp4",
                                attributes=[
                ...
                media = await bot.invoke(
                    raw.functions.messages.UploadMedia(
                        ...
                        media=raw.types.InputMediaUploadedDocument(
                            file=await bot.save_file(i.media),
                            thumb=await bot.save_file(i.thumb),
                            mime_type=bot.guess_mime_type(getattr(i.media, "name", "video.mp4"))
                            or "video/mp4",
                            attributes=[
                                raw.types.DocumentAttributeVideo(
                                    supports_streaming=i.supports_streaming or None,
            ...
            if isinstance(i.media, str):
                if os.path.isfile(i.media):
                    media = await bot.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await bot.resolve_peer(chat_id),
                            media=raw.types.InputMediaUploadedDocument(
                                mime_type=bot.guess_mime_type(i.media) or "audio/mpeg",
                                file=await bot.save_file(i.media),
                                thumb=await bot.save_file(i.thumb),
                                attributes=[
                ...
                media = await bot.invoke(
                    raw.functions.messages.UploadMedia(
                        peer=await bot.resolve_peer(chat_id),
                        media=raw.types.InputMediaUploadedDocument(
                            mime_type=bot.guess_mime_type(getattr(i.media, "name", "audio.mp3"))
                            or "audio/mpeg",
                            file=await bot.save_file(i.media),
                            thumb=await bot.save_file(i.thumb),
                            attributes=[
            ...
            if isinstance(i.media, str):
                if os.path.isfile(i.media):
                    media = await bot.invoke(
                        raw.functions.messages.UploadMedia(
                            peer=await bot.resolve_peer(chat_id),
                            media=raw.types.InputMediaUploadedDocument(
                                mime_type=bot.guess_mime_type(i.media) or "application/zip",
                                file=await bot.save_file(i.media),
                                thumb=await bot.save_file(i.thumb),
                                attributes=[
                                    raw.types.DocumentAttributeFilename(
                ...
                media = await bot.invoke(
                    raw.functions.messages.UploadMedia(
                        peer=await bot.resolve_peer(chat_id),
                        media=raw.types.InputMediaUploadedDocument(
                            mime_type=bot.guess_mime_type(getattr(i.media, "name", "file.zip"))
                            or "application/zip",
                            file=await bot.save_file(i.media),
                            thumb=await bot.save_file(i.thumb),
                            attributes=[
        ...
        multi_media.append(
            raw.types.InputSingleMedia(
                ...
                **await bot.parser.parse(i.caption, i.parse_mode),
            )
        )
